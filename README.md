<img src="readme.webp" align="right" width="200">
...
[^2]:Scientific writing (論文の書き方)に関しても、海外の教科書等を参考に、継続的に指導を行います。
...
- `R/Rstudio`: 各学生の[PC内](https://posit.co/download/rstudio-desktop/)での作業環境。データ分析やコードを書くためのソフトウェアです。
